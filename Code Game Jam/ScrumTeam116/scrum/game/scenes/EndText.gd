...
func _ready():	
	...
	var ma_liste = [
		"Tu n'as pas été assez rapide, tes parents t'ont jeté de chez toi",
		"T'es trop lent, retente quand tu seras un grand garçon",
		"Tips: la prochaine fois utilise ton cerveau"
	]
