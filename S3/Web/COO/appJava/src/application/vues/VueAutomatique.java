...
public class VueAutomatique extends JPanel {
    ...
    public VueAutomatique(ModeleAutomatique modele) {
        _modele = modele;
        ...
        LBLtitre.setForeground(Color.decode("#1E3A8A"));
        LBLtitre.setHorizontalAlignment(SwingConstants.CENTER);

        LBLsousTitre = new JLabel("Automatiquement");
        LBLsousTitre.setFont(new Font("Arial", Font.BOLD, 19));
        LBLsousTitre.setForeground(Color.decode("#334155"));
        ...
        LBLliste.setForeground(Color.decode("#1E3A8A"));
        ...
        JPanel titreListePanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
        titreListePanel.setOpaque(false);
        titreListePanel.add(LBLliste);
        contentPanel.add(titreListePanel, BorderLayout.NORTH);

        PNLlisteGroupes = new JPanel();
        PNLlisteGroupes.setLayout(new GridLayout(0, 4, 15, 15)); // Un peu plus d'espace (15px)
